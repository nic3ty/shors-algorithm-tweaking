...
# QME (Quantum Modular Exponentiation)
...
# Modular Exponentiation (double ew)
...
def parseArgs():
	...
	parser.add_argument('-a', '--attempts', type=int, default=100, help='Number of quantum attemtps to perform')
	parser.add_argument('-n', '--neighborhood', type=float, default=0.05, help='Neighborhood size for checking candidates (as percentage of N)')
	parser.add_argument('-p', '--periods', type=int, default=5, help='Number of periods to get before determining least common multiple')
